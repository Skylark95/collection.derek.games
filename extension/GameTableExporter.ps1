function global:ExportGameTable()
{
    ...
    if ($path)
    {
        ...
        $PlayniteApi.Database.Games | Select-Object -Property Name, $Library, $ReleaseYear, $Developer, $Publisher, CriticScore, CommunityScore | ConvertTo-Json | Out-File $path -Encoding utf8
